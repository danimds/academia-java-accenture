...
public class ProdutoCadastroTela extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProdutoCadastroTela frame = new ProdutoCadastroTela();
	...
	public ProdutoCadastroTela() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				servico.cadastrarProduto(nome, preco, tipo, descricao);
