...
public class FuncionarioEditarTela extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FuncionarioEditarTela frame = new FuncionarioEditarTela();
	...
	public FuncionarioEditarTela() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				funcionarioServico.atualizarFuncionario(id, nome, cpf, telefone, cargo, salario, data, endereco);
		...
		JLabel lblNewLabel = new JLabel("Editar Funcion\u00E1rio");
		panel_2.add(lblNewLabel);
	}
	
	public void inicializar(int id) {
		this.id = id;
		Funcionario funcionario = funcionarioServico.recuperarFuncionario(id);
		...
		textFieldTelefone.setText(funcionario.getTelefone());
		textFieldDatadeNascimento.setText(funcionario.getDataNascimento());
		
		textFieldRua.setText(funcionario.getEndereco().getRua());
		textFieldNumero.setText(funcionario.getEndereco().getNumero());
		textFieldCEP.setText(funcionario.getEndereco().getCep());
		textFieldUF.setText(funcionario.getEndereco().getEstado());
		textFieldBairro.setText(funcionario.getEndereco().getBairro());
		textFieldCidade.setText(funcionario.getEndereco().getCidade());
